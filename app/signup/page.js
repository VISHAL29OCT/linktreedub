      ...
      <div className="flex flex-col px-12 py-10">
        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <p className="text-xs text-gray-500 mt-6 leading-relaxed">
            By clicking Continue, you agree to Linktree’s{" "}
        ...
        <div className="butttons flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 my-8">
            ...
            <span className="text-gray-700 text-sm mx-auto">Already have a Account ? <a className="text-blue-700" href="/login">Login</a></span>
